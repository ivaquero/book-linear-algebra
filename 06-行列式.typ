#import "lib/lib.typ": *
#show: chapter-style.with(title: "行列式", info: info)
...
#definition[
  ...
  $
    |𝑨| & = |a_(i j)| \
        ...
        & = sum (-1)^t a_(1 p_1) a_(2 p_2) … a_(n p_n)
  $
...
#theorem(title: ctext("Laplace 展开"))[
  $n$阶方阵$𝑨 = (a_(i j))$的行列式，可表示成该方阵的某一行（列）各元素与其对应的代数余子式乘积之和，即

  $ |𝑨| = sum_(j=1)^n a_(i j) 𝑨_(i j) $
...
#theorem[
  ...
  $ sum_(k=1)^n a_(j k) 𝑨_(i k) = 0 med(i ≠ j) $
]
