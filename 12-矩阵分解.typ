...
#definition[
  ...
  $ 𝑷 = (𝒆_(pi(1)), 𝒆_(pi(2)), ..., 𝒆_(pi(n))) $
  其中，$pi: {1, 2, ..., n} → {1, 2, ..., n}$为一个双射，也称为${1, 2, ..., n}$的一个置换。
]
...
$
  norm(𝑨)_p = norm(σ)_p = root(p, sum_(i=1)^(min{m, n})σ_i^p)
$

- 当$p = 1$，范数的值等于矩阵奇异值之和，称核范数

$ norm(𝑨)_* = sum_(i=1)^(min{m, n}) σ_i $
